...
// $class = 'inline-block items-center px-2 py-1 font-bold bg-black text-white rounded-full shadow-lg uppercase tracking-wider hover:border-transparent hover:text-gray-900 bg-accent_hover focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150';
