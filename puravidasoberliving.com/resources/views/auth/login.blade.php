                        ...
                        <div class="inner text-white">
                            ...
                            <form class="space-y-6" method="POST" action="{{ route('login') }}">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input id="password_login" type="password" name="password" required autocomplete="current-password" autofocus placeholder="DaP@ssword1" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    >
                                        <input @click="isChecked = ! isChecked" x-bind:checked="isChecked" id="remember-me" name="remember-me" type="checkbox"  class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                            ...
                            <form class="space-y-6" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="flex w-full gap-x-2">
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <input id="firstName" type="text" name="firstName" :value="old('firstName')" required autocomplete="given-name" autofocus placeholder="Issac" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <input id="lastName" type="text" name="lastName" :value="old('lastName')" required autocomplete="family-name" autofocus placeholder="Newton" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input id="password" type="password" name="password" :value="old('password')"  required autocomplete="password" autofocus placeholder="DaP@ssword1" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
