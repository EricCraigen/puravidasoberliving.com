        ...
        {{-- <div class="box-container mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="box-item">
                ...
                <div class="flip-box">
                    ...
                    <div class="flip-box-front bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10" id="flip_box_front">
                        ...
                        <div class="inner text-white">
                            ...
                            <form class="space-y-6" method="POST" action="{{ route('login') }}">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input id="email" type="email" name="email" :value="old('email')" required autofocus class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
                      
                                <div>
                                    <label for="password" :value="__('Password')" class="block text-sm font-medium text-gray-700">
                                        {{ __('Password') }}
                                    </label>
                                    <div class="mt-1">
                                ...
                                <div class="switch-wrapper">
                                    <div class="switch-content-wrapper text-black">
                                        <div class="switch-label-wrapper">
                                            <p class="switch-label active">Login</p>
                                        </div>
                                        <div class="switch-label-wrapper">
                                            <p class="switch-label">Register</p>
                                        </div>
                    ...
                    <div class="flip-box-back text-center" style="background-image: url('https://s25.postimg.cc/l2q9ujy4f/cta-4.png');"  id="flip_box_back">
...
<script type="text/javascript">
    ...
    $(".switch-label-wrapper").click(function() {
        ...
        $('#flip_box_front').toggleClass('down');
        // $('.flip-box').toggleClass('down');

        $('#flip_box_back').toggleClass('up');
        $('.flip-box').toggleClass('flip-box-flipper');
