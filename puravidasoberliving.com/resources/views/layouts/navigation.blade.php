<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 md:-my-px md:ml-10 md:flex">
                    ...
                    <div class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent ml-6 {{ Route::currentRouteName() == 'a-la-carte-recovery' ? 'border-b-2 border-indigo-400' : 'hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out' }}">
                        <x-dropdown align="right" width="auto">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('a-la-carte-recovery')" :active="request()->routeIs('a-la-carte-recovery')">
                                    {{ __('About PVSL') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('a-la-carte-recovery')" :active="request()->routeIs('a-la-carte-recovery')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="block pl-3 pr-4 border-l-4 border-transparent text-base font-medium {{ Route::currentRouteName() == 'a-la-carte-recovery' ? 'border-indigo-400' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out' }}">
                {{--  --}}
                <x-dropdown align="left" width="auto">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center w-auto pr-4 py-2 text-base font-medium text-gray-500 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            <div>{{ __('Á La Carte Recovery') }}</div>
