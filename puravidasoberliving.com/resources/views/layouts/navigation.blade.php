...
<div class="flex w-full h-10 px-2 items-center justify-between bg-accent relative z-50 {{ $isPreviewActive ? $previewActive ? 'z-0' : '' : '' }}">
    ...
    @if (Auth::check())
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button
                    class="flex items-center text-sm font-bold text-gray-800 transition duration-150 ease-in-out hover:text-white hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
    ...
    <div class="flex">
        <div class="inline-flex items-center h-100">
            <a class="mr-2 font-bold text-black hover:text-white" href="{{ route('login') }}">
                {{ __('Login/Register') }}
            </a>
            {{-- <a class="font-bold text-black hover:text-white" href="{{ route('register') }}">
                {{ __('Register') }}
            </a> --}}
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 lg:-my-px lg:ml-10 lg:flex">
                    ...
                    {{-- <div class="inline-flex items-center px-1 pt-1 ml-6 h-100">
            ...
            <div class="hidden lg:flex lg:items-center lg:ml-6">
                <div class="inline-flex items-center hidden px-1 pt-1 scale-100 h-100" id="apply_today_nav_btn">
                    <form action="{{ route('apply-now') }}" method="GET">
                        @csrf
                        <x-nav-button onclick="event.preventDefault();
                        // console.log(authBtn);
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div
                ...
                <x-dropdown align="left" width="auto">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center w-auto py-2 pr-4 text-base font-medium text-gray-500 transition duration-150 ease-in-out focus:outline-none focus:text-gray-700 focus:border-gray-300">
                            <div>{{ __('Á La Carte Recovery') }}</div>
            ...
            <div class="inline-flex items-center hidden px-1 pt-1 mr-6 scale-100 h-100" id="apply_today_nav_btn_responsive">
                <form action="{{ route('apply-now') }}" method="GET">
                    @csrf
                    <x-nav-button onclick="event.preventDefault();
                    this.closest('form').submit();" :active="request()->routeIs('apply-now')">
...
<script type="text/javascript">
    ...
    function minifyNavOnScroll(scrollPos) {
        ...
        // console.log(scrollPos);
        if (scrollPos < 340) {
            $('#apply_today_nav_btn').removeClass('show').addClass('hide');
            $('#apply_today_nav_btn_responsive').removeClass('show').addClass('hide');
            window.setTimeout(function() {
                $('#apply_today_nav_btn').removeClass('hidden');
                $('#apply_today_nav_btn_responsive').removeClass('hidden');
            }, 1000);
        } else {
            $('#apply_today_nav_btn').removeClass('hidden').removeClass('hide').addClass('show');
            $('#apply_today_nav_btn_responsive').removeClass('hidden').removeClass('hide').addClass('show');
        }
    }
