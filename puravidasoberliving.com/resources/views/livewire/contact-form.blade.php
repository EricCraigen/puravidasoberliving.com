<div class="bg-gray-100 py-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:py-24">
    <div class="relative bg-white max-w-xl mx-auto p-5 rounded-md shadow-lg">
      ...
      <div class="mt-12">
        <form wire:submit.prevent="contactFormSubmit" action="/contact" method="POST" class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
          <div>
